    ...
    public static Mesh loadMesh(String fileName) throws Exception {
    	...
    	while(true){
    		...
    		if(in_line.startsWith("vt")) {
    			...
    			txt_list.add(Float.parseFloat(in_line.substring(space_idx2+1, in_line.length())));
    			continue;
    		}
    		...
    		if(in_line.startsWith("f")) {
    			...
    			idx_list.add(Integer.parseInt(in_line.substring(space_idx1+1, in_line.indexOf("//", space_idx1+1))));
