...
public class Transformation {
    ...
    /*
    public final Matrix4f getProjectionMatrix(float r, float l, float t, float b, float f, float n) {
    	projectionMatrix.identity();
    ...
    */
    ...
    public Matrix4f getViewMatrix(Camera camera) {
        ...
        viewMatrix.m10(x.y);
        viewMatrix.m20(x.z);
        viewMatrix.m30((-1)*(x.x*cameraPos.x+x.y*cameraPos.y+x.z*cameraPos.z));
        
        viewMatrix.m01(y.x);
        viewMatrix.m11(y.y);
        viewMatrix.m21(y.z);
        viewMatrix.m31((-1)*(y.x*cameraPos.x+y.y*cameraPos.y+y.z*cameraPos.z));
        
        viewMatrix.m02(z.x);
        viewMatrix.m12(z.y);
        viewMatrix.m22(z.z);
        viewMatrix.m32((-1)*(z.x*cameraPos.x+z.y*cameraPos.y+z.z*cameraPos.z));
